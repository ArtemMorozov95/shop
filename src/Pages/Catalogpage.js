...
function Catalogpage() {
  ...
  function filterfilter(e){
    filter = e.target.value
    setFilter(filter)
    let val = filter.trim();
    let filteritem = document.querySelectorAll('.filterlabel')
    if (val != ''){
  ...
  let sortBtn = document.querySelectorAll('.sort__btns-btn')
  let sortP = document.querySelectorAll('.filter__care__text')

  sortBtn.forEach((item, i) =>{
    item.addEventListener('click', function(){
      item.classList.toggle('bcgclr')
      sortP.forEach((text, n) =>{
        if(i == n){
  ...
  sortP.forEach((item, i) =>{
    item.addEventListener('click', function(){
      item.classList.toggle('underline')
      sortBtn.forEach((text, n) =>{
        if(i == n){
          text.classList.toggle('bcgclr')
        }
      })
    }) 
  })
  
  let data = Array.from(Product.products)

  // data = data.filter(x => x..includes('Уход за телом'))
  
  // data = data.filter(z => z.destination == 'Уход за ногами')
  // let btn = document.querySelectorAll('.sort__btns-btn')
  // btn.forEach((x) =>{
  ...
  let dataname = data.sort((a,b) => value == 'price' ? a.price - b.price : value == 'name' ? b.name - a.name : value == 'max' ? a.price - b.price : value == 'min' ? b.price - a.price : '').map(item =>{
    function addto(e){
        cost += +item.price
        setCost(cost)
    }
    ...
    <div >
        ...
        <div className='intro'>
                ...
                <button className='intro__btn'>
                    Каталог
                    <svg className='intro__btn__icon' width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='intro__call'>
                    <div>
                        <p className='intro__call-txt'>+7 (777) 490-00-91</p>
                        <p className='intro__call-subtxt'>время работы: 9:00-20:00</p>
                        <p className='intro__call-subsubtxt'>Заказать звонок</p>
                    </div>
                    <img src='call___women.png'></img>
                </div>

                <button className='intro__btn'>
                    Прайс-лист
                    <svg className='intro__btn__icon' width="18" height="17" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='basket'>
                    <div className='basket__icon'>
                        <svg className='basket__icon' width="41" height="29" viewBox="0 0 41 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div>
                        ...
                        <p className='basket__subtext'>{cost}</p>
                    </div>
                </div>
            </div>
    </div>
        ...
        <div className='upsort'>
            ...
            <div className='sort'>
                ...
                <p className='sort__subtext'>Сортировка :  
                    <select className='sort__select' onChange={changeSelect}>
            ...
            <div className='sort__btns'>
                ...
                <button className='sort__btns-btn' value='Уход за руками' >Уход<br/> за руками</button>
                <button className='sort__btns-btn' value='Уход за ногами' >Уход<br/> за ногами</button>
                <button className='sort__btns-btn' value='Уход за лицом'>Уход<br/> за лицом</button>
                <button className='sort__btns-btn' value='Уход за волосами'>Уход<br/> за волосами</button>
                <button className='sort__btns-btn' value='Средства для загар'>Средства<br/> для загара</button>
                <button className='sort__btns-btn' value='Средства для бритья'>Средства<br/> для бритья</button>
                <button className='sort__btns-btn' value='Подарочные наборы'>Подарочные<br/> наборы</button>
                <button className='sort__btns-btn' value='Гигиеническая продукция'>Гигиеническая<br/> продукция</button>
                <button className='sort__btns-btn' value='Гигиена полости рта'>Гигиена<br/> полости рта</button>
                <button className='sort__btns-btn' value='Бумажная продукция'>Бумажная<br/> продукция</button>
            </div>
        </div>
    </div>
        <div className="container">
            <div className='filtercatalog'>
              ...
              <h1 className='filtercatalog__text'>ПОДБОР ПО ПАРАМЕТРАМ</h1>
                  <div className='filter__price'>
                      <p className='filter__price-text'>Цена ₸</p>
                      <div className='filter__price-inputs'>
                          <input type='text' className='filter__price-input'></input>
                          <p>-</p>
                          <input type='text' className='filter__price-input'></input>
                      </div>
                  </div>
                  <div className='filter__manufacturer'>
                    <p className='filter__manufacturer__text'>Производитель</p>
                    <div className="filter__manufacturer__search">
                      <form className='manufacturer__search-form'>
                          <input type="text" placeholder="Поиск   ..."  className='filterinput' onInput={filterfilter}/>
                          <button type="submit" >
                              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M15.5294 15.5294L12.0989 12.0928L15.5294 15.5294ZM14 7.5C14 9.22391 13.3152 10.8772 12.0962 12.0962C10.8772 13.3152 9.22391 14 7.5 14C5.77609 14 4.12279 13.3152 2.90381 12.0962C1.68482 10.8772 1 9.22391 1 7.5C1 5.77609 1.68482 4.12279 2.90381 2.90381C4.12279 1.68482 5.77609 1 7.5 1C9.22391 1 10.8772 1.68482 12.0962 2.90381C13.3152 4.12279 14 5.77609 14 7.5V7.5Z" stroke="white" strokeWidth="1.3" strokeLinecap="round"/>
                              </svg>
                    ...
                    <div className='filter__manufacturer__checkboxs' >
                        <label className="filterlabel">
                          <input type="checkbox" className='filter__manufacturer__checkbox'/>
                          Grifon
                        </label>
                        <label className="filterlabel">
                          <input type="checkbox" className='filter__manufacturer__checkbox'/>
                        ...
                        <div className='filter__manufacturer__show'>
                            <a className='show__text'>Показать все</a>
                            <svg className='show__icon' width="7" height="6" viewBox="0 0 7 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M3.5 6L0.468911 0.750001L6.53109 0.75L3.5 6Z" fill="#3F4E65"/>
                            </svg>
                        </div>
                    </div>
                    <div className='filter__care'>
                        <p className='filter__care__text'>Уход за телом</p>
                        <p className='filter__care__text'>Уход за руками</p>
                        <p className='filter__care__text'>Уход за ногами</p>
                        <p className='filter__care__text'>Уход за лицом</p>
                        <p className='filter__care__text'>Уход за волосами</p>
                        <p className='filter__care__text'>Средства для загара</p>
                        <p className='filter__care__text'>Средства для бритья</p>
                        <p className='filter__care__text'>Подарочные наборы</p>
                        <p className='filter__care__text'>Гигиеническая продукция</p>
                        <p className='filter__care__text'>Гигиена полости рта</p>
                        <p className='filter__care__text'>Бумажная продукция</p>
                    </div>
                  </div>
              </div>
            <div className="catalog__outer">
